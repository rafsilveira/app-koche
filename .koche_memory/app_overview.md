...
- O fluxo padrão de desenvolvimento e verificação deve usar o ambiente beta (`npm run dev` e `npm run build:beta`); builds de produção (`npm run build:app`) devem ficar para momentos explicitamente solicitados.
